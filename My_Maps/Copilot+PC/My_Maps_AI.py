import typing, My_Maps_AI_Interface, transformers, torch, intel_npu_acceleration_library
...
class My_Maps_LM(My_Maps_AI_Interface.My_Maps_AI_interface):
    ...
    @typing.override
    def __response__(self: typing.Self, pipe: transformers.Pipeline = None, prompt: str = None) -> str:
        ...
        self.query: str = f"<|system|>You are a helpful and experianced geographer.<|end|><|user|>{prompt}<|end|><|assistant|>"
