import customtkinter, tkinter.messagebox, pickle, typing, My_Maps_setting_window_interface
...
class My_Maps_setting_window(customtkinter.CTkToplevel, My_Maps_setting_window_interface.My_Maps_setting_window_interface):
