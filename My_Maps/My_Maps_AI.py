import g4f, g4f.local, typing, My_Maps_AI_Interface
...
class My_Maps_LM(My_Maps_AI_Interface.My_Maps_AI_interface):
    ...
    def __init__(self: typing.Self) -> None:
        self.my_maps_ai_client: g4f.local.LocalClient = g4f.local.LocalClient()

    @typing.override
    async def __response__(self: typing.Self, prompt: str) -> str:
        self.response = self.my_maps_ai_client.chat.completions.create(model=self.LM, messages=[{f"role": f"user", f"content": prompt}])
